...
J'ai également mis en application la [proposition]({{ site.url }}/2003/12/30/Le-petit-Mont-Royal) de [Kicou](http://yvonet.com/) de mettre seulement certains articles indexables par Google. Si vous regardez le code, vous remarquerez que quasiment toutes les pages contiennent un meta "noindex, follow" sauf certains articles auxquels j'ai attribué un mot-clé particulier. Je vous tiendrai au courant de l'impact sur les visites Google.
